<div class="row">
	...
	<div class="col-md-1 col-xs-1 col-lg-1 urgente">
		Urg. <span id="urgente"><?=$urgente?></span>
	</div>
...
<div class="row">
	<div style="margin-top:10px;border:3px solid blue; padding:5px;" class="col-lg-6 col-md-6 col-sm-6 col-xs-6 ">
	...
	<div class="col-md-6" id="buscadorCliente">
		<div class="row">
		  	<div class="col-lg-12 ">
