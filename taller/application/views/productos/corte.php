		...
		<table class="table table-striped tabla" id="tabla-reportes">
			...
			<tbody>
				...
				<tr>
					...
					<td data-id="<?=$row->id_venta?>" data-prod="<?=$row->id_producto?>"><button type="button" class="btn btn-danger glyphicon glyphicon-trash btn-xs btnVenta"></button><a class="btn btn-info btn-xs" href="<?=base_url()?>Venta/nota/<?=$row->id_venta?>" target="_blank"><span class="glyphicon glyphicon-print"></span></a></td>
				</tr>
				<?php }?>
			</tbody>
		</table>
